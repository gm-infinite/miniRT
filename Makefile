...
UTIL_SOURCES		= draw_scene.c draw_scene_utils.c color.c vector.c transformation.c objects_constructors.c objects_intersection.c objects_intersection2.c vector2.c point.c
