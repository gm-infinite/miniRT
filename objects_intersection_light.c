...
int	plane_intersection_l(t_ray_light ray, t_plane plane, t_intersection *inter)
{
	double		d;
	t_vector	normal;
...
int	sphere_intersection_l(t_ray_light ray, t_sphere sphere, t_intersection *inter)
{
	t_vector	oc;
	t_vector	nor;
	double		b;
...
t_vector	calculate_cylinder_normal_l(t_ray_light ray, t_cylinder cy, double t,
		int hit_type)
{
	t_vector	normal;
