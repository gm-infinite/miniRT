...
int	cylinder_side_check_l(t_ray ray, t_ray ray_m, t_cylinder cy,
...
int	cylinder_caps_check_l(t_ray ray, t_ray ray_m, t_cylinder cy,
		t_intersection *inter)
{
	double	cap_t;
	int		found;
...
int	cylinder_intersection_l(t_ray ray, t_cylinder cy, t_intersection *inter)
{
	t_ray	ray_m;
	int		side_hit;
	int		cap_hit;
